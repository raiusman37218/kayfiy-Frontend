    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="group flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:bg-[#1EBE5D] cursor-pointer"
        >
